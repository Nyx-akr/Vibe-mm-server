...
const SOCIAL_FEEDS = [
  { source: "4chan", label: "4chan /biz/ catalog + busiest threads", fetch: fetchBizThreads },
  { source: "reddit", label: "reddit atom feeds (" + REDDIT_BATCH + " of " + REDDIT_SUBS.length + " subreddits per refresh)", fetch: fetchRedditPosts },
  { source: "mastodon", label: "mastodon public hashtag timelines", fetch: fetchMastodonPosts },
  { source: "farcaster", label: "warpcast keyless cast search", fetch: fetchFarcasterCasts },
  { source: "bluesky", label: "bluesky crypto feed generators", fetch: fetchBlueskyPosts },
];
